      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <button
            ...
            className="md:hidden w-10 h-10 flex items-center justify-center rounded-lg bg-gradient-to-br from-orange-50 to-red-50 hover:from-orange-100 hover:to-red-100 transition-all active:scale-95 shadow-sm hover:shadow-md"
            aria-label="Toggle menu"
          >
            <div className="relative w-6 h-5 flex flex-col justify-center gap-1.5">
              <span 
                className={`absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-600 to-red-600 rounded-full transition-all duration-300 ${
                  mobileMenuOpen ? 'rotate-45 top-2' : ''
                }`}
              ></span>
              <span 
                className={`absolute top-2 left-0 w-full h-0.5 bg-gradient-to-r from-orange-600 to-red-600 rounded-full transition-all duration-300 ${
                  mobileMenuOpen ? 'opacity-0' : 'opacity-100'
                }`}
              ></span>
              <span 
                className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-600 to-red-600 rounded-full transition-all duration-300 ${
            ...
            <>
              ...
              >
                <div className="flex flex-col h-full py-8 px-6">
                  ...
                  <button
                    onClick={() => setMobileMenuOpen(false)}
                    className="self-end mb-8 w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-orange-100 text-gray-700 hover:text-orange-600 transition-all hover:scale-110 active:scale-95"
                  ...
                  <div className="flex flex-col gap-3 mb-8">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 px-5 py-4 text-black hover:text-orange-600 hover:bg-gradient-to-r hover:from-orange-50 hover:to-red-50 transition-all font-bold rounded-xl group shadow-sm hover:shadow-md"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      <div className="flex-shrink-0 w-6 h-6 text-orange-600 group-hover:scale-110 transition-transform">
