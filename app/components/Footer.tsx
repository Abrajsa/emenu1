...
export default function Footer({ lang }: FooterProps) {
  ...
  return (
    <footer
      className={`w-full bg-gray-900 text-white ${isRTL ? 'rtl' : 'ltr'}`}
      dir={isRTL ? 'rtl' : 'ltr'}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            >
              {lang === 'ar'
                ? 'حلول قوائم إلكترونية مبتكرة لمطاعمك ومقاهيك'
                : 'Innovative electronic menu solutions for your restaurants and cafes'}
            </p>
          </div>

          {/* Contact Information */}
          <div>
            <h4 className={`text-lg font-bold mb-4 ${isRTL ? 'font-arabic' : ''}`}>
              {t.getInTouch}
            </h4>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <span className={`text-gray-400 text-sm ${isRTL ? 'font-arabic' : ''}`}>
                {t.followUs}:
              </span>
